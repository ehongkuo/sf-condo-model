    ...
    return (
      <div className="tab-fade-in">
        ...
        <div className="card" style={{ marginBottom: "24px" }}>
          ...
          <div className="card-body">
            <p style={{ color: "#94a3b8", marginBottom: "20px" }}>
              When you move out and rent to a tenant, the IRS treats this as a
              business. Your expenses move from Schedule A (personal) to{" "}
              <strong>Schedule E (rental)</strong>. This changes which items are
              deductible:
            </p>
            <div className="tax-item-grid">
              <div className="tax-item yes">
                ...
                <div className="tax-item-amount">
                  {formatCurrency(rentalInterest / 12)} / mo (your 50%)
                </div>
                <div className="tax-item-note">
                  Still deductible — and now there's{" "}
                  <strong>no $750k cap</strong> because it's a business expense.
                </div>
              </div>
              <div className="tax-item yes">
                <div className="tax-item-header">
                ...
                <div className="tax-item-amount">
                  {formatCurrency(rentalPropertyTax / 12)} / mo (your 50%)
                </div>
                <div className="tax-item-note">
                  Still deductible — and now it{" "}
                  <strong>bypasses the SALT cap</strong> entirely.
                </div>
              </div>
              <div
              ...
              >
                ...
                <div className="tax-item-amount">
                  {formatCurrency(rentalHOA / 12)} / mo (your 50%)
                </div>
                <div className="tax-item-note">
                  <strong>Newly deductible!</strong> HOA was not deductible as
                  an owner — but as a landlord, it's a legitimate business
                  expense.
                </div>
              </div>
              <div
              ...
              >
                ...
                <div className="tax-item-amount">
                  {formatCurrency(userShareOfDepreciation / 12)} / mo (your 50%)
                </div>
                <div className="tax-item-note">
                  <strong>New "phantom" deduction!</strong> The IRS lets you
                  write off the building's value over 27.5 years — even though
                  you didn't spend any cash.
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="card" style={{ marginBottom: "24px" }}>
          ...
          <div className="card-body">
            <p style={{ color: "#94a3b8", marginBottom: "20px" }}>
              The IRS wants to know: did your rental make money or lose money on
              paper?
            </p>
            ...
            >
              ...
              >
                Income (your 50% of rent)
              </div>
              <div className="row">
                <span>50% of Tenant Rent:</span>{" "}
            ...
            {netRentalIncome >= 0 ? (
              <>
                ...
                <p style={{ color: "#94a3b8", fontSize: "0.95rem" }}>
                  This tax is offset by the rental income itself. Your net cash
                  from the rental is still positive.
                </p>
              </>
            ) : (
              <>
                <p style={{ color: "#94a3b8", marginBottom: "20px" }}>
                  ...
                  the depreciation deduction. Here's what happens with that
                  loss:
                </p>
                <div
                  style={{
                ...
                >
                  ...
                  >
                    🚫 Can you use this loss to reduce your W2 taxes?
                  </div>
                  <div className="row">
                    <span>Your MAGI:</span> <span>~$213,000</span>
                  </div>
                  <div className="row">
                    <span>IRS rental loss allowance phases out at:</span>{" "}
                    <span>$150,000</span>
                  </div>
                  <hr style={{ opacity: 0.2 }} />
                  <div className="row total">
                    ...
                    <span style={{ color: "#f87171" }}>
                      Fully phased out — loss is suspended
                    </span>
                  </div>
                </div>
                ...
                >
                  ...
                  >
                    ✅ But the loss isn't wasted
                  </div>
                  <p style={{ color: "#e2e8f0", margin: "0 0 12px 0" }}>
                    This {formatCurrency(Math.abs(netRentalIncome))}/yr loss is{" "}
                    <strong>suspended</strong> and accumulates. When you
                    eventually sell the property, all suspended losses unlock
                    and reduce your capital gains taxes — potentially saving you
                    tens of thousands.
                  </p>
                  <div className="row">
                    <span>Annual suspended loss:</span>{" "}
                    <span>{formatCurrency(Math.abs(netRentalIncome))}</span>
                  </div>
                  <div className="row">
                    <span>Cumulative loss (Year {selectedYear}):</span>{" "}
                    <span style={{ color: "#4ade80" }}>
                      {formatCurrency(cumulativeSuspendedLoss)}
                    </span>
                  </div>
                  <div className="row">
                    <span>Additional tax owed on rental income:</span>{" "}
                    <span className="positive">
                      {formatCurrency(0)} (it's a loss!)
                    </span>
                  </div>
                </div>
              </>
        ...
        <div className="card" style={{ marginBottom: "24px" }}>
          ...
          <div className="card-body">
            <p style={{ color: "#94a3b8", marginBottom: "20px" }}>
              The key question: is the rental better or worse than just keeping
            ...
            <div style={{ display: "flex", gap: "24px", flexWrap: "wrap" }}>
              ...
              >
                ...
                <div className="row" style={{ marginTop: "8px" }}>
                  <span>Rental income:</span> <span>$0</span>
                </div>
              </div>
              ...
              >
                ...
                >
                  With the rental (Year {selectedYear}):
                </div>
                <div className="row">
                  <span>W2 Income:</span> <span>$213,000</span>
                </div>
                ...
                <div className="row">
                  <span>W2 Taxable Income:</span> <span>$196,900</span>
                </div>
                <div className="row" style={{ marginTop: "8px" }}>
                  <span>Rental Net (Schedule E):</span>{" "}
                  <span className={netRentalIncome >= 0 ? "" : "positive"}>
                    {formatCurrency(netRentalIncome)}
                    {netRentalIncome < 0 ? " (suspended)" : ""}
                  </span>
                </div>
                {netRentalIncome >= 0 && (
                  <div className="row">
                    <span>Additional tax at 24%:</span>{" "}
                    <span className="negative">
                      -{formatCurrency(rentalTaxImpact)}
                    </span>
                  </div>
                )}
              </div>
        ...
        >
          ...
          <div>
            ...
            <p style={{ margin: 0, color: "#e2e8f0", lineHeight: 1.5 }}>
              When you sell, the IRS will "recapture" all depreciation you
              claimed and tax it at 25%. For each year you rent, that's{" "}
              <strong>{formatCurrency(userShareOfDepreciation)}</strong> per
              person added to your recapture liability. The Section 121 capital
